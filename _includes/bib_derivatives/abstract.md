...
*77th Annual Meeting of the American Epilepsy Society*, Orlando, FL, Dec. 2023.  &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/MantillaRamos_2023_AES_Seeg.bib)
...
*22nd International Workshop on Data Mining in Bioinformatics*, Long Beach, CA, Aug. 2023.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Liu_2023_BIOKDD_Cortical.pdf){:target="Liu_2023_BIOKDD_Cortical-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Liu_2023_BIOKDD_Cortical.bib)
...
*51st Annual Meeting of the Society for Neuroscience*, San Diego, CA, Nov. 2022.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Liu_2022_Neuroscience_Functional.pdf){:target="Liu_2022_Neuroscience_Functional-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Liu_2022_Neuroscience_Functional.bib)
...
*21th Annual International Symposium on Therapeutic Ultrasound*, Toronto, Canada, Jun. 2022.  &nbsp; [<i class="fa fa-link"></i>](https://istu.org/istu-2022-toronto/){:target="Daneshzand_2022_ISTU_Simulation-LINK"} &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Daneshzand_2022_ISTU_Simulation.pdf){:target="Daneshzand_2022_ISTU_Simulation-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Daneshzand_2022_ISTU_Simulation.bib)  
  <details>
...
*28th Annual Meeting of the Organization for Human Brain Mapping*, Glasgow, Scotland, Jun. 2022.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Li_2022_OHBM_Towards.pdf){:target="Li_2022_OHBM_Towards-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Li_2022_OHBM_Towards.bib)
...
*28th Annual Meeting of the Organization for Human Brain Mapping*, Glasgow, Scotland, Jun. 2022.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Cambareri_2022_OHBM_Exploration.pdf){:target="Cambareri_2022_OHBM_Exploration-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Cambareri_2022_OHBM_Exploration.bib)
...
*2nd Focused Ultrasound Neuromodulation Symposium*, Virtual Conference, Sept. 2021.  &nbsp; [<i class="fa fa-link"></i>](https://fun.web.ox.ac.uk){:target="Guerin_2021_FUN_Precomputation-LINK"} &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Guerin_2021_FUN_Precomputation.pdf){:target="Guerin_2021_FUN_Precomputation-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Guerin_2021_FUN_Precomputation.bib)

* **J. Li**, W. H. Curley, B. Guerin, D. D. Dougherty, A. V. Dalca, A. Horn, B. L. Edlow,  
"The subcortical connectome of the default mode network",  
*NIH Common Fund's 2021 High-Risk, High-Reward Research Symposium*, Jun. 2021.  &nbsp; [<i class="fa fa-link"></i>](https://hrhr2021.dryfta.com){:target="Li_2021_NIH-HRHR_Subcortical-LINK"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Li_2021_NIH-HRHR_Subcortical.bib)
...
*27th Annual Meeting of the Organization for Human Brain Mapping*, Seoul, Korea, Jun. 2021.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Setton_2021_OHBM_Functional.pdf){:target="Setton_2021_OHBM_Functional-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Setton_2021_OHBM_Functional.bib)

* Y. Liu, **J. Li**, J. L. Wisnowski, A. A. Joshi, R. M. Leahy,  
"Brain network decomposition for naturalistic stimulus paradigm",  
*27th Annual Meeting of the Organization for Human Brain Mapping*, Seoul, Korea, Jun. 2021.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Liu_2021_OHBM_Brain.pdf){:target="Liu_2021_OHBM_Brain-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Liu_2021_OHBM_Brain.bib)
...
*27th Annual Meeting of the Organization for Human Brain Mapping*, Seoul, Korea, Jun. 2021.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Li_2021_OHBM_Mapping.pdf){:target="Li_2021_OHBM_Mapping-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Li_2021_OHBM_Mapping.bib)
...
*74th Annual Meeting of the American Epilepsy Society*, Seattle, WA, Dec. 2020.  &nbsp; [<i class="fa fa-link"></i>](https://cms.aesnet.org/abstractslisting/functional-significance-of-epileptogenic-fast-activity--a-study-of-motor-cortex-seizures-){:target="Shaker_2020_AES_Functional-LINK"} &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Shaker_2020_AES_Functional.pdf){:target="Shaker_2020_AES_Functional-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Shaker_2020_AES_Functional.bib)  
  <details>
    <summary style="font-size:16px">Abstract</summary>
      <p style="margin-left: 20px; text-align: justify; font-size:16px">
      Rationale:
...
*26th Annual Meeting of the Organization for Human Brain Mapping*, Montreal, Canada, Jun. 2020.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Joshi_2020_OHBM_Novel.pdf){:target="Joshi_2020_OHBM_Novel-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Joshi_2020_OHBM_Novel.bib)
...
*61st Annual Meeting of the American Society of Hematology*, Orlando, FL, Dec. 2019.  &nbsp; [<i class="fa fa-link"></i>](https://doi.org/10.1182/blood-2019-129544){:target="Choi_2019_ASH_Exploring-LINK"} &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Choi_2019_ASH_Exploring.pdf){:target="Choi_2019_ASH_Exploring-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Choi_2019_ASH_Exploring.bib)
...
*73rd Annual Meeting of the American Epilepsy Society*, Baltimore, MD, Dec. 2019.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Kobayashi_2019_AES_Association.pdf){:target="Kobayashi_2019_AES_Association-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Kobayashi_2019_AES_Association.bib)
...
*73rd Annual Meeting of the American Epilepsy Society*, Baltimore, MD, Dec. 2019.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Li_2019_AES_Fingerprint.pdf){:target="Li_2019_AES_Fingerprint-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Li_2019_AES_Fingerprint.bib)

* H. Akrami, A. A. Joshi, **J. Li**, R. M. Leahy,  
"Traumatic brain injury lesion detection using a variational autoencoder",  
*73rd Annual Meeting of the American Epilepsy Society*, Baltimore, MD, Dec. 2019.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Akrami_2019_AES_Traumatic.pdf){:target="Akrami_2019_AES_Traumatic-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Akrami_2019_AES_Traumatic.bib)

* A. A. Joshi, H. Akrami, **J. Li**, R. M. Leahy,  
"A matched filter decomposition of task fMRI for extraction of dynamical components",  
*25th Annual Meeting of the Organization for Human Brain Mapping*, Rome, Italy, Jun. 2019.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Joshi_2019_OHBM_Matched.pdf){:target="Joshi_2019_OHBM_Matched-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Joshi_2019_OHBM_Matched.bib)
...
*25th Annual Meeting of the Organization for Human Brain Mapping*, Rome, Italy, Jun. 2019.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Choi_2019_OHBM_Alterations.pdf){:target="Choi_2019_OHBM_Alterations-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Choi_2019_OHBM_Alterations.bib)
...
*24th Annual Meeting of the Organization for Human Brain Mapping*, Singapore, Republic of Singapore, Jun. 2018.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Li_2018_OHBM_Identifying.pdf){:target="Li_2018_OHBM_Identifying-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Li_2018_OHBM_Identifying.bib)

* H. Akrami, A. A. Joshi, **J. Li**, R. M. Leahy,  
"Average template for comparison of resting fMRI based on group synchronization of their time series",  
*24th Annual Meeting of the Organization for Human Brain Mapping*, Singapore, Republic of Singapore, Jun. 2018.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Akrami_2018_OHBM_Average.pdf){:target="Akrami_2018_OHBM_Average-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Akrami_2018_OHBM_Average.bib)

* A. A. Joshi, D. McCoy, M. Chong, **J. Li**, S. Choi, D. Shattuck, R. M. Leahy,  
"BFP: BrainSuite fMRI pipeline",  
*24th Annual Meeting of the Organization for Human Brain Mapping*, Singapore, Republic of Singapore, Jun. 2018.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Joshi_2018_OHBM_Bfp.pdf){:target="Joshi_2018_OHBM_Bfp-PDF"} &nbsp; [<i class="fa fa-code"></i>](http://brainsuite.org/){:target="Joshi_2018_OHBM_Bfp-CODE"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Joshi_2018_OHBM_Bfp.bib)
...
*40th Annual Meeting of the Research Society on Alcoholism*, Denver, CO, Jun. 2017.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Li_2017_RSA_Modeling.pdf){:target="Li_2017_RSA_Modeling-PDF"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Li_2017_RSA_Modeling.bib)

* **J. Li**, S. Choi, R. M. Leahy,  
"Global PDF-based non-local means filtering of resting fMRI data",  
*23rd Annual Meeting of the Organization for Human Brain Mapping*, Vancouver, Canada, Jun. 2017.  &nbsp; [<i class="fa fa-file-pdf-o"></i>](/files/pdf/Li_2017_OHBM_Global.pdf){:target="Li_2017_OHBM_Global-PDF"} &nbsp; [<i class="fa fa-code"></i>](/software/GPDF/gpdf_main){:target="Li_2017_OHBM_Global-CODE"} &nbsp; [<i class="fa fa-quote-right"></i>](/files/bib/Li_2017_OHBM_Global.bib)
